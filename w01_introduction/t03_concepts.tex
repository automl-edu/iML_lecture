...
\begin{frame}[c]{Types of Explanations}
	\begin{center}
		\includegraphics[width=0.7\textwidth]{w01_introduction/figure/1-attributions.png}
    \end{center}
\end{frame}
...
\begin{frame}[c]{Explanation using training instances~\lit{Koh et al. 2017}{https://arxiv.org/pdf/1703.04730.pdf}}
	...
	\begin{center}
		\includegraphics[page=1, width=0.7\textwidth]{w01_introduction/figure/fish-attribution.pdf}
	\end{center}
...
\begin{frame}[c]{Explanation using training instances~\lit{Koh et al. 2017}{https://arxiv.org/pdf/1703.04730.pdf}}
	...
	\textbf{Data attribution:} Which training instances results in the decision for the instance $x$ of the model ?
	\begin{center}
		\includegraphics[page=1, width=0.7\textwidth]{w01_introduction/figure/prototypes-fish.pdf}
	\end{center}
	\begin{itemize}
		\item Methods: 
...
\begin{frame}[c]{Explanation using Counterfactuals}
	...
	\begin{center}
		\includegraphics[page=1, width=0.7\textwidth]{w01_introduction/figure/counterfactual.pdf}
	\end{center}
...
\begin{frame}[c]{Local vs Global Explanations}
	\begin{center}
		\includegraphics[width=0.7\textwidth]{w01_introduction/figure/1-local-global.png}
	\end{center}
\end{frame}
