...
\begin{document}
    ...
    \begin{frame}{Regression on Bike Rentals}
        ...
        \centering
        \includegraphics[width=0.55\textwidth]{./figures/lin_bikesharing.png}
    ...
    \begin{frame}{Decision Tree on Bike Rentals}
        ...
        \centering
        \includegraphics[width=0.55\textwidth]{./figures/dt_bike_sharing.png}
	...
	\begin{frame}{Logistic Regression on  Cancer (Classification)}
        ...
        \centering
        \includegraphics[width=0.55\textwidth]{./figures/lin_cancer.png}
	...
	\begin{frame}{Decision Tree on  Cancer (Classification)}
        ...
        \centering
        \includegraphics[width=0.55\textwidth]{./figures/dt_cancer.png}
    \end{frame}
